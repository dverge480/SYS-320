...
echo "To: dylan.verge@mymail.champlain.edu" > emailform.txt
echo "Subject: Logins" >> emailform.txt
getLogins >> emailform.txt
cat emailform.txt | ssmtp dylan.verge@mymail.champlain.edu

# Todo - 2
# Send failed logins as email to yourself.
# Similar to sending logins as email
echo "To: dylan.verge@mymail.champlain.edu" > emailform02.txt
echo "Subject: Login Fails" >> emailform02.txt
getFailedLogins >> emailform02.txt
cat emailform02.txt | ssmtp dylan.verge@mymail.champlain.edu 
